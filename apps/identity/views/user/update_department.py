...
from apps.identity.models import User
from apps.identity.serializers.user import UpdateUserDepartmentSerializer
from apps.identity.services.user.update import update_user_department
from apps.authz.permissions import HasPermission
from apps.common.constants import IAMPermissions
